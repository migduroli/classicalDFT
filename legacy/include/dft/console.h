#ifndef DFT_CONSOLE_H
#define DFT_CONSOLE_H
...
namespace dft::console {
  ...
  namespace format {
     ...
     * @return std::string
     */
    inline std::string blink(const std::string& msg) {
   ...
   */
  template <class T>
  static void write_line(const T& msg) {
   ...
   */
  template <class T>
  static void write_line(const std::initializer_list<T>& msg) {
