...
Our wrapper lives within the `dft` namespace, which is the core namespace of the `classicalDFT` library, and is encapsulated within the namespace `grace_plot`. The wrapper consists mainly in a `class` and several `enum` structures. Basically:
...
int main(int argc, char **argv)
{
  ...
  g.SetColor(dft::grace_plot::Color::RED, dataset_id);
  g.RedrawAndWait();
  //endregion
  ...
  console::Debug("The new dataset id = " + std::to_string(dataset_id));
  g.SetColor(dft::grace_plot::BLUE, existing_dataset_id);
  g.RedrawAndWait();
  ...
  //g.SetColor(dft::grace_plot::MAGENTA, existing_dataset_id);
  g.RedrawAndWait();
  //endregion

  //region Example of axis labels
  console::Info("Example: Setting the X and Y labels");
  g.SetLabel("This is X", dft::grace_plot::Axis::X);
  g.SetLabel("This is Y", dft::grace_plot::Axis::Y);
  g.RedrawAndWait();
  //endregion
  ...
  g.SetLineType(dft::grace_plot::LineStyle::NO_LINE, 0);
  g.RedrawAndWait(false, false);
  g.SetLineType(dft::grace_plot::LineStyle::LINE, 0);
  g.RedrawAndWait(false, false);
  g.SetLineType(dft::grace_plot::LineStyle::DOTTEDLINE, 0);
  g.RedrawAndWait(false, false);
  g.SetLineType(dft::grace_plot::LineStyle::DASHEDLINE_EN, 0);
  g.RedrawAndWait(false, false);
  //endregion

  //region Example of setting symbols and fills
  console::Info("Example: Setting symbol and symbol color");
  g.SetSymbol(dft::grace_plot::Symbol::TRIANGLE_DOWN, 0);
  g.SetSymbolColor(dft::grace_plot::Color::BLUE, 0);
  g.SetSymbolFill(dft::grace_plot::Color::BLUE, 0, 0, 4);

  g.SetSymbol(dft::grace_plot::Symbol::TRIANGLE_LEFT, 1);
  g.SetSymbolColor(dft::grace_plot::Color::DARKGREEN, 1);

  g.SetSymbol(dft::grace_plot::Symbol::DIAMOND, 2);
  g.SetSymbolFill(dft::grace_plot::Color::RED, 2);
  g.RedrawAndWait(false, false);
  //endregion
  ...
  g.PrintToFile("test_graph.png", dft::grace_plot::ExportFormat::PNG);
  //g.PrintToFile("test_graph.pdf", dft::grace_plot::ExportFormat::PDF);
  //g.PrintToFile("test_graph.jpg", dft::grace_plot::ExportFormat::JPG);
  //g.PrintToFile("test_graph.eps", dft::grace_plot::ExportFormat::EPS1);
  //g.PrintToFile("test_graph.ps", dft::grace_plot::ExportFormat::PS);
  g.RedrawAndWait(false, false);
  //endregion
}
```
