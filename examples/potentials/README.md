...
int main(int argc, char **argv)
{
  ...
  using namespace dft::potentials::intermolecular;
  ...
  g.SetLineType(dft::grace_plot::LineStyle::NO_LINE, lj_min);
  g.SetSymbol(dft::grace_plot::Symbol::SQUARE, lj_min);
  g.SetSymbolFill(dft::grace_plot::Color::RED, lj_min);
  //endregion
  ...
  g.SetColor(dft::grace_plot::Color::RED, lj_hs);
  g.SetLineType(dft::grace_plot::LineStyle::DASHEDLINE_EN, lj_hs);
  ...
  g.SetColor(dft::grace_plot::Color::RED, lj_att_ds);
  g.SetLineType(dft::grace_plot::LineStyle::D_DOTTEDDASHEDLINE_EM, lj_att_ds);
  g.SetSymbol(dft::grace_plot::Symbol::CIRCLE, lj_att_ds);
  ...
  g.SetColor(dft::grace_plot::Color::RED, lj_rep_ds);
  g.SetLineType(dft::grace_plot::LineStyle::D_DOTTEDDASHEDLINE_EN, lj_rep_ds);
  g.SetSymbol(dft::grace_plot::Symbol::STAR, lj_rep_ds);
  ...
  g.SetColor(dft::grace_plot::Color::BLUE,twf_ds);
  //endregion

  //region Minimum:
  auto twf_min = g.AddDataset(std::vector<double>{twf.r_min()}, std::vector<double>{twf.v_min()});
  g.SetLineType(dft::grace_plot::LineStyle::NO_LINE, twf_min);
  g.SetSymbol(dft::grace_plot::Symbol::DIAMOND, twf_min);
  g.SetSymbolFill(dft::grace_plot::Color::BLUE, twf_min);
  //endregion
  ...
  g.SetColor(dft::grace_plot::Color::BLUE, twf_hs);
  g.SetLineType(dft::grace_plot::LineStyle::DASHEDLINE_EN, twf_hs);
  ...
  g.SetColor(dft::grace_plot::Color::BLUE, twf_att_ds);
  g.SetLineType(dft::grace_plot::LineStyle::DOTTEDLINE, twf_att_ds);
  g.SetSymbol(dft::grace_plot::Symbol::STAR, twf_att_ds);
  ...
  g.SetColor(dft::grace_plot::Color::BLUE, twf_rep_ds);
  g.SetLineType(dft::grace_plot::LineStyle::D_DOTTEDDASHEDLINE_EN, twf_rep_ds);
  g.SetSymbol(dft::grace_plot::Symbol::STAR, twf_rep_ds);
  ...
  g.SetColor(dft::grace_plot::Color::ORANGE, wrdf_ds);
  //endregion

  //region Minimum:
  auto wrdf_min = g.AddDataset(std::vector<double>{wrdf.r_min()}, std::vector<double>{wrdf.v_min()});
  g.SetLineType(dft::grace_plot::LineStyle::NO_LINE, wrdf_min);
  g.SetSymbol(dft::grace_plot::Symbol::SQUARE, wrdf_min);
  g.SetSymbolFill(dft::grace_plot::Color::ORANGE, wrdf_min);
  //endregion
  ...
  g.SetColor(dft::grace_plot::Color::ORANGE, wrdf_hs);
  g.SetLineType(dft::grace_plot::LineStyle::DASHEDLINE_EN, wrdf_hs);
  ...
  g.SetColor(dft::grace_plot::Color::ORANGE, wrdf_att_ds);
  g.SetLineType(dft::grace_plot::LineStyle::D_DOTTEDDASHEDLINE_EM, wrdf_att_ds);
  g.SetSymbol(dft::grace_plot::Symbol::PLUS, wrdf_att_ds);
  ...
  g.SetColor(dft::grace_plot::Color::ORANGE, wrdf_rep_ds);
  g.SetLineType(dft::grace_plot::LineStyle::D_DOTTEDDASHEDLINE_EN, wrdf_rep_ds);
  g.SetSymbol(dft::grace_plot::Symbol::STAR, wrdf_rep_ds);
  ...
  //g.PrintToFile("potentials.png", dft::grace_plot::ExportFormat::PNG);
  //g.RedrawAndWait();
}
```
