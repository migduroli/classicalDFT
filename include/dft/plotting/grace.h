#ifndef DFT_PLOTTING_GRACE_H
#define DFT_PLOTTING_GRACE_H
...
namespace dft::plotting {
  ...
  namespace command {
     ...
     * @param color one of the possible Color values
     * @param dataset_id the integer number identifying the dataset the point will be associated top
     * @param graph_id the integer number identifying the graph the point will be represented on
     * @return std::string
     */
    std::string set_line_color_command(const Color& color, const int& dataset_id, const int& graph_id);
     ...
     * @return std::string
     */
    std::string set_symbol_color_command(const Color& color, const int& dataset_id, const int& graph_id);
     ...
     * @return std::string
     */
    std::string set_symbol_color_fill_command(const Color& color, const int& dataset_id, const int& graph_id);
     ...
     * @param axis the `Axis` where the text will serve as label, either X or Y
     * @return std::string
     */
    std::string set_axis_label_command(const std::string& label, const Axis& axis);
     ...
     * @return std::string
     */
    std::string set_symbol_command(const Symbol& symbol, const int& dataset_id, const int& graph_id);
  ...
  const double DEFAULT_MIN_AXIS_VALUE = 0.0;
  /// The value to be used as the default maximum of an axis
  const double DEFAULT_MAX_AXIS_VALUE = 10.0;
  ...
  const float DEFAULT_HORIZONTAL_SPACE = 0.15f;
  /// The default relative vertical space to be left
  const float DEFAULT_VERTICAL_SPACE = 0.2f;
   ...
   *
   * It uses `GraceRegisterErrorFunction` from `gnuplot_np.h` to register our personalised `error_parsing_function`
   ...
   */
  void start_grace_communication(const int& x_size, const int& y_size, int buffer_size = 2048);
  ...
  class Grace {
   public:
    ...
    [[nodiscard]] const bool& is_initialised() const { return show_; }
    /// The minimum value for the X axis
    [[nodiscard]] const double& x_min() const { return x_min_; }
    /// The maximum value for the X axis
    [[nodiscard]] const double& x_max() const { return x_max_; }
    /// The minimum value for the Y axis
    [[nodiscard]] const double& y_min() const { return y_min_; }
    /// The maximum value for the Y axis
    [[nodiscard]] const double& y_max() const { return y_max_; }
    /// The total number of graphs
    [[nodiscard]] const int& number_of_graphs() const { return number_of_graphs_; }
    /// The integer id of the last dataset
    [[nodiscard]] const int& last_dataset_id() const { return last_dataset_id_; }

    /// The offset
    [[nodiscard]] const float& offset() const { return offset_; }
    /// The hspace to be used when setting up the graphs
    [[nodiscard]] const float& horizontal_space() const { return horizontal_space_; }
    /// The vspace to be used when setting up the graphs
    [[nodiscard]] const float& vertical_space() const { return vertical_space_; }
     ...
     */
    void delete_dataset(const int& dataset_id, const int& graph_id = 0);
     ...
     * @throws GraceException in case the graph_id given is out of bounds
     */
    void set_legend(const std::string& legend, const int& dataset_id, const int& graph_id = 0) const;
     ...
     * @throws GraceException in case the graph_id given is out of bounds
     */
    void set_color(const Color& color, const int& dataset_id, const int& graph_id = 0) const;
     ...
     * @throws GraceException in case the graph_id given is out of bounds
     */
    void set_label(const std::string& label, const Axis& axis, const int& graph_id = 0) const;
     ...
     */
    void set_subtitle(const std::string& subtitle) const;
     ...
     * @param graph_id
     */
    void set_ticks(const double& dx, const double& dy, const int& graph_id = 0) const;
     ...
     * @throws GraceException in case the graph_id given is out of bounds
     */
    void set_symbol(const Symbol& symbol, const int& dataset_id, const int& graph_id = 0) const;
     ...
     * @throws GraceException in case the graph_id given is out of bounds
     */
    void set_symbol_size(const double& size, const int& dataset_id, const int& graph_id = 0) const;
     ...
     * @throws GraceException in case the graph_id given is out of bounds
     */
    void set_line_type(const LineStyle& line_type, const int& dataset_id, const int& graph_id = 0) const;
