...
namespace dft::physics::eos {
  ...
  struct IdealGas {
    ...
    template <typename T = double> [[nodiscard]] auto excess_free_energy(T /*density*/) const -> T { return T(0.0); }
  ...
  struct PercusYevick {
    ...
    template <typename T = double> [[nodiscard]] auto excess_free_energy(T density) const -> T {
  ...
  struct LennardJonesJZG {
    ...
    template <typename T> [[nodiscard]] auto g_integral(T rho, int i) const -> T;
  ...
  struct LennardJonesMecke {
    ...
    static constexpr std::array<Term, 32> TERMS = {{
        {.c = 0.33619760720e-05, .m = -2, .n = 9, .p = 0, .q = 0},
        {.c = -0.14707220591e+01, .m = -1, .n = 1, .p = 0, .q = 0},
        {.c = -0.11972121043e+00, .m = -1, .n = 2, .p = 0, .q = 0},
        {.c = -0.11350363539e-04, .m = -1, .n = 9, .p = 0, .q = 0},
        {.c = -0.26778688896e-04, .m = -0.5, .n = 8, .p = 0, .q = 0},
        {.c = 0.12755936511e-05, .m = -0.5, .n = 10, .p = 0, .q = 0},
        {.c = 0.40088615477e-02, .m = 0.5, .n = 1, .p = 0, .q = 0},
        {.c = 0.52305580273e-05, .m = 0.5, .n = 7, .p = 0, .q = 0},
        {.c = -0.10214454556e-07, .m = 1, .n = 10, .p = 0, .q = 0},
        {.c = -0.14526799362e-01, .m = -5, .n = 1, .p = -1, .q = 1},
        {.c = 0.64975356409e-01, .m = -4, .n = 1, .p = -1, .q = 1},
        {.c = -0.60304755494e-01, .m = -2, .n = 1, .p = -1, .q = 1},
        {.c = -0.14925537332e+00, .m = -2, .n = 2, .p = -1, .q = 1},
        {.c = -0.31664355868e-03, .m = -2, .n = 8, .p = -1, .q = 1},
        {.c = 0.28312781935e-01, .m = -1, .n = 1, .p = -1, .q = 1},
        {.c = 0.13039603845e-03, .m = -1, .n = 10, .p = -1, .q = 1},
        {.c = 0.10121435381e-01, .m = 0, .n = 4, .p = -1, .q = 1},
        {.c = -0.15425936014e-04, .m = 0, .n = 9, .p = -1, .q = 1},
        {.c = -0.61568007279e-01, .m = -5, .n = 2, .p = -1, .q = 2},
        {.c = 0.76001994423e-02, .m = -4, .n = 5, .p = -1, .q = 2},
        {.c = -0.18906040708e+00, .m = -3, .n = 1, .p = -1, .q = 2},
        {.c = 0.33141311846e+00, .m = -2, .n = 2, .p = -1, .q = 2},
        {.c = -0.25229604842e+00, .m = -2, .n = 3, .p = -1, .q = 2},
        {.c = 0.13145401812e+00, .m = -2, .n = 4, .p = -1, .q = 2},
        {.c = -0.48672350917e-01, .m = -1, .n = 2, .p = -1, .q = 2},
        {.c = 0.14756043863e-02, .m = -10, .n = 3, .p = -1, .q = 3},
        {.c = -0.85996667747e-02, .m = -6, .n = 4, .p = -1, .q = 3},
        {.c = 0.33880247915e-01, .m = -4, .n = 2, .p = -1, .q = 3},
        {.c = 0.69427495094e-02, .m = 0, .n = 2, .p = -1, .q = 3},
        {.c = -0.22271531045e-07, .m = -24, .n = 5, .p = -1, .q = 4},
        {.c = -0.22656880018e-03, .m = -10, .n = 2, .p = -1, .q = 4},
        {.c = 0.24056013779e-02, .m = -2, .n = 10, .p = -1, .q = 4},
    }};
