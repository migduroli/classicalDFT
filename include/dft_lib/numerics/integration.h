    ...
    namespace integration {
      ...
      class Integrator {
       private:
         ...
         * @remark For more information about `std::function` see
        ...
        /**
         * @brief The gsl_function structure to pass to the integration method
         * (https://www.gnu.org/software/gsl/doc/html/roots.html?highlight=gsl_function#c.gsl_function)
         */
         ...
         * by GSL integrators
         * (https://www.gnu.org/software/gsl/doc/html/integration.html?highlight=gsl_integration_workspace#c.gsl_integration_workspace)
         */
       ...
       public:
         ...
         */
        x_type function(x_type x) const { return method_(problem_, x); }
        ...
        double definite_integral(x_type limit_inferior, x_type limit_superior) const {
          ...
          gsl_integration_qags(&gsl_function_, limit_inferior, limit_superior, this->absolute_error_,
                               this->relative_error_, this->working_space_size_, this->working_space_.get(),
                               &this->result_, &this->error_);
        ...
        double definite_integral_fast(x_type limit_inferior, x_type limit_superior) const {
          ...
          gsl_integration_qng(&gsl_function_, limit_inferior, limit_superior, this->absolute_error_,
                              this->relative_error_, &this->result_, &this->error_, &number_of_evaluations);
      ...
      class FunctionIntegrator : public Integrator<FunctionIntegrator<params_type, return_type, x_type>, x_type> {
       ...
       public:
         ...
         */
        explicit FunctionIntegrator(general_method<return_type, x_type, params_type> method,
