...
namespace dft_core {
  namespace config_parser {
     ...
     */
    enum class FileType { INI = 0, JSON, INFO, XML };
    ...
    class ConfigParser {
     ...
     public:
       ...
       * @throw boost::property_tree::ini_parser_error In case of error deserialising the property tree (if
       * FileType::INI)
       * @throw boost::property_tree::json_parser_error In case of error deserialising the property tree (if
       * FileType::JSON)
       * @throw boost::property_tree::xml_parser_error In case of error deserialising the property tree (if
       * FileType::XML)
       * @throw boost::property_tree::info_parser_error In case of error deserialising the property tree (if
       * FileType::INFO)
       */
      explicit ConfigParser(std::string config_file,
                            const config_parser::FileType& file_type = DEFAULT_CONFIG_FILE_TYPE);
