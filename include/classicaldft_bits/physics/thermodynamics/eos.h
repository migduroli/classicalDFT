#ifndef CLASSICALDFT_PHYSICS_THERMODYNAMICS_EOS_H
#define CLASSICALDFT_PHYSICS_THERMODYNAMICS_EOS_H
...
namespace dft_core::physics::thermodynamics::eos {
  ...
  class PercusYevick final : public EquationOfState {
   ...
   private:
    dft_core::physics::thermodynamics::PercusYevick hs_{
        dft_core::physics::thermodynamics::PercusYevick::Route::Compressibility};
  };
...
#endif  // CLASSICALDFT_PHYSICS_THERMODYNAMICS_EOS_H
