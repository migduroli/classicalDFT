#ifndef CLASSICALDFT_PHYSICS_FMT_WEIGHTS_H
#define CLASSICALDFT_PHYSICS_FMT_WEIGHTS_H
...
namespace dft_core::physics::fmt {
  ...
  struct WeightSet {
     ...
     *
     * The callable receives a `ConvolutionField&`. Iterates in order:
  ...
  class Weights {
   public:
    /**
     * @brief Populates a WeightSet with the Fourier-space weights for a hard sphere.
     *
...
#endif  // CLASSICALDFT_PHYSICS_FMT_WEIGHTS_H
