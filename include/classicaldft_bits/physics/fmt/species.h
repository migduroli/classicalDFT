#ifndef CLASSICALDFT_PHYSICS_FMT_SPECIES_H
#define CLASSICALDFT_PHYSICS_FMT_SPECIES_H
...
namespace dft_core::physics::fmt {
  ...
  class Species : public species::Species {
   public:
     ...
     */
    [[nodiscard]] double compute_free_energy(const Functional& functional);
     ...
     */
    double compute_forces(const Functional& functional);
     ...
     */
    [[nodiscard]] Measures measures_at(arma::uword pos) const;

    /**
     * @brief Collapse 19 derivatives back to the 11 stored derivative arrays.
     */
    void set_derivatives(const Measures& dm, arma::uword pos, bool tensor);
...
#endif  // CLASSICALDFT_PHYSICS_FMT_SPECIES_H
