#ifndef CLASSICALDFT_PHYSICS_INTERACTION_INTERACTION_H
#define CLASSICALDFT_PHYSICS_INTERACTION_INTERACTION_H
...
namespace dft_core::physics::interaction {
  ...
  class Interaction {
   public:
    ...
    Interaction(
        species::Species& s1,
        species::Species& s2,
        const potentials::intermolecular::Potential& potential,
        double kT,
    ...
    [[nodiscard]] const species::Species& species_1() const noexcept;
    [[nodiscard]] const species::Species& species_2() const noexcept;
   ...
   private:
    ...
    species::Species& s1_;
    species::Species& s2_;
    const potentials::intermolecular::Potential& potential_;
    double kT_;
    ...
    fmt::ConvolutionField convolution_;
  };

}  // namespace dft_core::physics::interaction

#endif  // CLASSICALDFT_PHYSICS_INTERACTION_INTERACTION_H
