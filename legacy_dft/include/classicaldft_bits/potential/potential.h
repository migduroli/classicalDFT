#ifndef CLASSICALDFT_POTENTIAL_POTENTIAL_H
#define CLASSICALDFT_POTENTIAL_POTENTIAL_H
...
namespace dft::potentials {
  ...
  enum class PotentialName { LennardJones = 0, tenWoldeFrenkel, WangRamirezDobnikarFrenkel };
    ...
    class Potential {
     ...
     public:
      ...
      [[nodiscard]] double epsilon_shift() const;
      [[nodiscard]] double r_cutoff() const;
      [[nodiscard]] double r_min() const;
      [[nodiscard]] double v_min() const;
      [[nodiscard]] double r_attractive_min() const;
      [[nodiscard]] double r_zero() const;
      [[nodiscard]] bool bh_perturbation() const;
      [[nodiscard]] double kT() const;
      [[nodiscard]] const PotentialName& id() const;
      ...
      [[nodiscard]] double w_attractive_r2(double r_squared) const;
      ...
      [[nodiscard]] virtual double find_hard_core_diameter() const = 0;
      /// Computes the position where the potential reaches its minimum
      [[nodiscard]] virtual double find_r_min() const = 0;
     ...
     *      More information about the LJ[12-6] potential can be found at:
    ...
    class LennardJones final : public Potential {
     ...
     public:
      ...
      [[nodiscard]] double find_hard_core_diameter() const override;
      [[nodiscard]] double find_r_min() const override;
    ...
    class WangRamirezDobnikarFrenkel final : public Potential {
     ...
     public:
      ...
      /**
       * @brief Constructor used for the parameterization of a WangRamirezDobnikarFrenkel object (sigma, epsilon,
       * r_cutoff)
       * @param sigma The typical length scale defining the problem at hand
       * @param epsilon The typical energy scale defining the problem at hand
       * @param r_cutoff The distance at which the potential energy is considered negligible, hence used
...
#endif  // CLASSICALDFT_POTENTIAL_POTENTIAL_H
