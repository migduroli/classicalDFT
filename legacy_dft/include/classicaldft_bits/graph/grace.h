...
namespace dft::graph {
  ...
  namespace command {
     ...
     * @param color one of the possible graph::Color values
     * @param dataset_id the integer number identifying the dataset the point will be associated top
     * @param graph_id the integer number identifying the graph the point will be represented on
     * @return std::string
     */
    std::string set_line_color_command(const graph::Color& color, const int& dataset_id, const int& graph_id);
     ...
     * @return std::string
     */
    std::string set_symbol_color_command(const graph::Color& color, const int& dataset_id, const int& graph_id);
    ...
    std::string set_symbol_color_fill_command(
        const graph::Color& color, const int& dataset_id, const int& graph_id
    );
     ...
     * @param axis the `graph::Axis` where the text will serve as label, either X or Y
     * @return std::string
     */
    std::string set_axis_label_command(const std::string& label, const graph::Axis& axis);
