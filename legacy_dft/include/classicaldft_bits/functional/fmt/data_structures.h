#ifndef CLASSICALDFT_FUNCTIONAL_FMT_DATA_STRUCTURES_H
#define CLASSICALDFT_FUNCTIONAL_FMT_DATA_STRUCTURES_H
...
namespace dft::functional::fmt {
  ...
  struct FundamentalMeasures {
     ...
     */
    [[nodiscard]] static FundamentalMeasures uniform(double density, double diameter) {
...
#endif  // CLASSICALDFT_FUNCTIONAL_FMT_DATA_STRUCTURES_H
