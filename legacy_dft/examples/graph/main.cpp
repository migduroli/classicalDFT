...
int main(int argc, char **argv)
{
  ...
  g.set_color(dft::graph::Color::RED, dataset_id);
  g.redraw_and_wait();
  //endregion
  ...
  console::debug("The new dataset id = " + std::to_string(dataset_id));
  g.set_color(dft::graph::Color::BLUE, existing_dataset_id);
  g.redraw_and_wait();
  ...
  //g.set_color(dft::graph::MAGENTA, existing_dataset_id);
  g.redraw_and_wait();
  //endregion

  //region Example of axis labels
  console::info("Example: Setting the X and Y labels");
  g.set_label("This is X", dft::graph::Axis::X);
  g.set_label("This is Y", dft::graph::Axis::Y);
  g.redraw_and_wait();
  //endregion
  ...
  g.set_line_type(dft::graph::LineStyle::NO_LINE, 0);
  g.redraw_and_wait(false, false);
  g.set_line_type(dft::graph::LineStyle::LINE, 0);
  g.redraw_and_wait(false, false);
  g.set_line_type(dft::graph::LineStyle::DOTTEDLINE, 0);
  g.redraw_and_wait(false, false);
  g.set_line_type(dft::graph::LineStyle::DASHEDLINE_EN, 0);
  g.redraw_and_wait(false, false);
  //endregion

  //region Example of setting symbols and fills
  console::info("Example: Setting symbol and symbol color");
  g.set_symbol(dft::graph::Symbol::TRIANGLE_DOWN, 0);
  g.set_symbol_color(dft::graph::Color::BLUE, 0);
  g.set_symbol_fill(dft::graph::Color::BLUE, 0, 0, 4);

  g.set_symbol(dft::graph::Symbol::TRIANGLE_LEFT, 1);
  g.set_symbol_color(dft::graph::Color::DARKGREEN, 1);

  g.set_symbol(dft::graph::Symbol::DIAMOND, 2);
  g.set_symbol_fill(dft::graph::Color::RED, 2);
  g.redraw_and_wait(false, false);
  //endregion
  ...
  g.print_to_file("export/test_graph.png", dft::graph::ExportFormat::PNG);
  //g.print_to_file("export/test_graph.pdf", dft::graph::ExportFormat::PDF);
  //g.print_to_file("export/test_graph.jpg", dft::graph::ExportFormat::JPG);
  //g.print_to_file("export/test_graph.eps", dft::graph::ExportFormat::EPS1);
  //g.print_to_file("export/test_graph.ps", dft::graph::ExportFormat::PS);
  g.redraw_and_wait(false, false);
  //endregion
}