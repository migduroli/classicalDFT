...
namespace dft::functional::fmt {
  ...
  double WeightGenerator::volume_hat(double k, double r) {
    if (k < 1e-12) {
  ...
  double WeightGenerator::surface_hat(double k, double r) {
    if (k < 1e-12) {
  ...
  double WeightGenerator::vector_prefactor(double k, double r) {
    if (k < 1e-12) {
      return 0.0;
    }
    double k_r = k * r;
  ...
  std::pair<double, double> WeightGenerator::tensor_coefficients(double k, double r) {
    if (k < 1e-12) {
  ...
  void WeightGenerator::generate(double diameter, double dx, const std::vector<long>& shape, WeightedDensitySet& w) {
