...
| Model | Bulk EOS | $f_{\mathrm{ex}}$ |
|-------|----------|-------------------|
| Rosenfeld | PYc | $-\ln(1-\eta) + \frac{3\eta}{1-\eta} + \frac{3\eta^2}{2(1-\eta)^2}$ |
| White Bear I/II | CS | $\frac{4\eta - 3\eta^2}{(1-\eta)^2}$ |
...
All comparisons use Jim's `FMT.h` as reference.
