...
**InterpolationQuadraticF**: 27-point quadrature (QF scheme). For each
...
is the most accurate scheme and matches the legacy `Interaction.cpp` to $10^{-10}$.
...
All comparisons use the legacy `Interaction.cpp` (`generate_weight_QF`) as reference.
