...
TEST(grace_plot_command, set_symbol_color_ok_test)
{
  ...
  std::string actual = dft_core::grace_plot::command::set_symbol_color_command(dft_core::grace_plot::Color::BLACK, 1, 0);
  ASSERT_STREQ(expected.c_str(), actual.c_str());
}
...
TEST(grace_plot_command, set_symbol_fill_color_ok_test)
{
  ...
  std::string actual = dft_core::grace_plot::command::set_symbol_color_fill_command(dft_core::grace_plot::Color::BLACK, 1, 0);
  ASSERT_STREQ(expected.c_str(), actual.c_str());
}
...
TEST(grace_plot_command, set_symbol_line_type_ok_test)
{
  ...
  std::string actual = dft_core::grace_plot::command::set_line_style_command(
...
{
  EXPECT_THROW(
      dft_core::grace_plot::send_command("hello world"),
...
{
  EXPECT_THROW(
      dft_core::grace_plot::start_grace_communication(-10, 10, 1000),
...
{
  EXPECT_THROW(
      dft_core::grace_plot::get_number_of_rows(-10),
      dft_core::exception::GraceException
  );
  EXPECT_THROW(
      dft_core::grace_plot::get_number_of_rows(0),
      dft_core::exception::GraceException
  );
}
...
{
  EXPECT_THROW(
      dft_core::grace_plot::get_number_of_columns(-10, 2),
      dft_core::exception::GraceException
  );
  EXPECT_THROW(
      dft_core::grace_plot::get_number_of_columns(0, 2),
      dft_core::exception::GraceException
  );
  EXPECT_THROW(
      dft_core::grace_plot::get_number_of_columns(2, 0),
      dft_core::exception::GraceException
  );
  EXPECT_THROW(
      dft_core::grace_plot::get_number_of_columns(2, -10),
      dft_core::exception::GraceException
  );
}
//endregion
...
TEST(grace_class, set_color_throws_excp_dataset_id)
{
  ...
  EXPECT_THROW(
      g.set_color(dft_core::grace_plot::Color::BLUE, 1, 0),
      dft_core::exception::GraceException
  );
}
...
TEST(grace_class, set_color_throws_excp_graph_id)
{
  ...
  EXPECT_THROW(
      g.set_color(dft_core::grace_plot::Color::RED, 0, 1),
      dft_core::exception::GraceException
  );
}
...
TEST(grace_class, set_lable_throws_excp_graph_id)
{
  ...
  EXPECT_THROW(
      g.set_label("test", dft_core::grace_plot::Axis::X, 12),
      dft_core::exception::GraceException
  );

  EXPECT_THROW(
      g.set_label("test", dft_core::grace_plot::Axis::Y, 12),
      dft_core::exception::GraceException
  );
}
