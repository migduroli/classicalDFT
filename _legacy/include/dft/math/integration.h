#ifndef DFT_MATH_INTEGRATION_H
#define DFT_MATH_INTEGRATION_H
...
namespace dft::math::integration {
  // region Constants:
  ...
  class Integrator {
   private:
    ...
    GslWorkspacePtr working_space_{nullptr, gsl_integration_workspace_free};
   ...
   public:
    ...
    static x_type integrand_function(x_type x, void* param) {
      auto* integrator_obj = static_cast<Integrator*>(param);
